...
در این بخش ابتدا همه‌ی اعضای گروه به صورت مساله فکر کردند و سپس در یک جلسه‌ی اسکایپ به صورت آنلاین ،برنامه با راهنمایی و ایده‌های متین امینی و ملینا مهرانی گفته شده و توسط آیدا افشارمحمدیان کد نوشته شد و روی دیتای آزمایشی آزمایش شد.
